          ...
          <div className="max-w-6xl text-center space-y-12">
            ...
            <div className="grid grid-cols-5 sm:grid-cols-5 md:grid-cols-5 lg:grid-cols-10 gap-4 sm:gap-6 md:gap-8 items-center justify-items-center max-w-5xl mx-auto">
              ...
              <div className="flex flex-col items-center space-y-3 group cursor-pointer">
                ...
                <span className="text-sm text-black font-medium">安卓</span>
              </div>
              ...
              <div className="flex flex-col items-center space-y-3 group cursor-pointer">
                ...
                <span className="text-sm text-black font-medium">火狐</span>
              </div>
              ...
              <div className="flex flex-col items-center space-y-3 group cursor-pointer">
                ...
                <span className="text-sm text-black font-medium">控制台</span>
              </div>
              ...
              <div className="flex flex-col items-center space-y-3 group cursor-pointer">
                ...
                <span className="text-sm text-black font-medium">路由器</span>
              </div>
            </div>

            <div className="pt-6">
              <p className="text-lg text-black max-w-2xl mx-auto">
                无论您使用什么设备，MistCurrent 都能为您提供强大的加密保护和极速连接体验
              </p>
            </div>
          </div>
        </div>
