      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-white mb-12 max-w-2xl mx-auto drop-shadow-md">
            全球节点极速覆盖，军工级加密安全可靠。让您在数字世界中自由畅行无阻，享受真正的网络自由。
          </p>
        ...
        <div className="mt-20 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <span className="text-sm font-semibold text-green-300">无日志政策</span>
              <span className="text-xs text-white">严格保护用户隐私</span>
            </div>
            <div className="flex flex-col items-center space-y-2">
              <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mb-2 border border-white/30">
                <div className="w-3 h-3 bg-purple-400 rounded-full"></div>
              </div>
              <span className="text-sm font-semibold text-green-300">24/7 客服支持</span>
              <span className="text-xs text-white">全天候专业服务</span>
            </div>
          </div>
        </div>
      </div>
